...
The preable does not have content, but rather information about the document. 
The first line of latex document is the documentclass. This command holds info on which type of
document we want to create, and what are it's properties.
